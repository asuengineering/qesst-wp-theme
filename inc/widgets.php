...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Home Page Card Area', 'understrap' ),
				'id'            => 'homecards',
				'description'   => __( 'A teaser-style card section within the home page.', 'understrap' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Home Page Content Sections', 'understrap' ),
				'id'            => 'homecontent',
				'description'   => __( 'Rows of content/images below the main hero space for the home page.', 'understrap' ),
